...
public class BookServiceImpl implements BookService {
    ...
    public String insertBook(String name, String year, String authorId, String genreId) {
        ...
        Book book = bookDAO.save(new Book(null,
    ...
    public String updateBook(String id, String name, String year, String authorId, String genreId) {
        ...
        return String.format("Обновлена книга%s%s", System.lineSeparator(), toString(bookDAO.save(book)));
    }
    ...
    public String getBookById(String id) {
        ...
        return bookDAO.findById(container.getId()).map(this::toStringWithComments).orElse("Книга не найдена");
    }
    ...
    public String deleteById(String id) {
        ...
        bookDAO.deleteBookById(container.getId());
