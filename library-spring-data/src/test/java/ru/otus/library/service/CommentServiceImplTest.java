...
class CommentServiceImplTest {
    ...
    void shouldAddNewComment() {
        given(bookRepository.findById(1L)).willReturn(Optional.of(expectedComment().getBook()));
    ...
    private Comment expectedComment() {
        ...
        Book book = new Book(1L, "Евгений Онегин", 1833, author, genre, null);
        return new Comment(1L, book, "Интересный сюжет");
    }
